...
There is no one-size-fits-all solution to this problem. It depends on the size of your dataset, the memory of your nodes, the network speed, the number of nodes, the number of mappers and reducers, the complexity of your computation etc.
