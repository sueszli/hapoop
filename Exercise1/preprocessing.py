...
stopwords = {
    ...
    "anywhere", "apart", "app", "appear", "appreciate", "appropriate", "are", "aren", "around", 
    "as", "aside", "ask", "asking", "associated", "at", "available", "away", "awfully", "b", "baby", 
    "bb", "be", "became", "because", "become", "becomes", "becoming", "been", "before", "beforehand", 
    ...
    "doesn", "dog", "dogs", "doing", "doll", "don", "done", "down", "downwards", "during", "e", "each", 
    ...
    "in", "inasmuch", "inc", "indeed", "indicate", "indicated", "indicates", "ink", "inner", "insofar", 
    "install", "instead", "into", "inward", "is", "isn", "it", "its", "itself", "j", "just", "k", "keep", 
    "keeps", "kept", "kitchen", "knife", "know", "known", "knows", "l", "lamp", "laptop", "last", "lately", 
    "later", "latter", "latterly", "least", "less", "lest", "let", "life", "like", "liked", "likely", "little", 
    "ll", "look", "looking", "looks", "ltd", "m", "mainly", "many", "may", "maybe", "me", "mean", "meanwhile", 
    "merely", "might", "mon", "more", "moreover", "most", "mostly", "movie", "mower", "much", "must", "my", 
    ...
    "phone", "placed", "please", "plus", "possible", "presumably", "printer", "probably", "product", "provides", "q", 
    "que", "quite", "qv", "r", "rather", "rd", "re", "read", "really", "reasonably", "regarding", "regardless", 
    ...
    "serious", "seriously", "seven", "several", "shall", "shave", "she", "shoes", "should", "shouldn", "since", "six", 
    "skin", "so", "some", "somebody", "somehow", "someone", "something", "sometime", "sometimes", "somewhat", "somewhere", 
    "song", "soon", "sorry", "specified", "specify", "specifying", "still", "story", "strings", "stroller", "sub", "such", 
    "sup", "sure", "t", "take", "taken", "taste", "tell", "tends", "th", "than", "thank", "thanks", "thanx", "that", 
    "thats", "the", "their", "theirs", "them", "themselves", "then", "thence", "there", "thereafter", "thereby", 
    "therefore", "therein", "theres", "thereupon", "these", "they", "think", "third", "this", "thorough", "thoroughly", 
    "those", "though", "three", "through", "throughout", "thru", "thus", "to", "together", "too", "took", "toward", 
    "towards", "toy", "tried", "tries", "truck", "truly", "try", "trying", "twice", "two", "u", "un", "under", 
    "unfortunately", "unless", "unlikely", "until", "unto", "up", "upon", "us", "use", "used", "useful", "uses", 
    "using", "usually", "v", "value", "various", "ve", "very", "via", "viz", "vs", "want", "wants", "was", 
    "wasn", "way", "we", "wear", "welcome", "well", "went", "were", "weren", "what", "whatever", "when", 
    ...
    "willing", "wish", "with", "within", "without", "won", "wonder", "would", "wouldn", "x", "y", "yes", 
    "yet", "you", "your", "yours", "yourself", "yourselves", "z", "zero"
}


class MRTextPreprocessor(MRJob):
